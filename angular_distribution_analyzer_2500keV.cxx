...
void angular_distribution_analyzer_2500keV()
{
    ...
    for(int i=1; i<= number_of_SX3_bins; i++)
    {
    	...
    	peak_fit[i] = new TF1 ( peak_fit_name,"peak_fit_function",1500, 3200, 6 );

    	peak_fit[i]->SetParameters ( 15, 2500, 140, 5, 3000, 140 );

        peak_fit[i]->SetParLimits(1,2300,2700);
        peak_fit[i]->SetParLimits(4,2900, 3100);
	...
	//Calculating the angular distribution
    ...
    for(int i=1; i<= number_of_QQQ5_bins; i++)
    {
        ...
        peak_fit_QQQ5[i] = new TF1 ( peak_fit_name_QQQ5,"peak_fit_function",1500, 3200, 6 );

        peak_fit_QQQ5[i]->SetParameters ( 15, 2500, 140, 5, 3000, 140 );
        peak_fit_QQQ5[i]->SetParLimits ( 0, 0, 10000);

        peak_fit_QQQ5[i]->SetParLimits(1,2300,2700);
        peak_fit_QQQ5[i]->SetParLimits(4,2900, 3100);
    ...
    {
        c1->cd(k);
        Ex_AngularBin_SX3[k]->GetXaxis()->SetRangeUser(1000, 4000);
    ...
    {
        c4->cd(k);
        Ex_AngularBin_QQQ5[k]->GetXaxis()->SetRangeUser(1000, 4000);

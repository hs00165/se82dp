...
*/
    ...
    TH1D* uQQQ5_energy_CH2 = new TH1D("uQQQ5_energy_CH2", "uQQQ5_energy_CH2", 2000, 0, 5000);
...
/*
    	...
    	*/
        ...
        if(QQQ5Mul >= 1)
        {
            for(int j=0; j<QQQ5Mul; j++)
            {
                ...
                if(QQQ5Upstream[j]==1 && icE >= 500 && QQQ5Ring[j] >= 22) uQQQ5_energy_CH2->Fill(QQQ5RingADC[j]);
    ...
    TFile write("CH2_hist.root", "recreate");
    uQQQ5_energy_CH2->Write();
